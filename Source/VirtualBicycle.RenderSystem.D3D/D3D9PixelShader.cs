...
namespace VirtualBicycle.Graphics.D3D9
{
    internal class D3D9PixelShader : PixelShader
    {
        ...
        public D3D9PixelShader(D3D9RenderSystem rs, string code, Macro[] defines, Include include, string functionName, string profile)
            : base(rs)
        {
            ...
            ps = new D3D.PixelShader(device, byteCode);

            ConstantTable = new D3D9ConstantTable(rs, byteCode.ConstantTable);
        }

        internal D3D.PixelShader D3DPS 
        {
            get { return ps; }
        }
