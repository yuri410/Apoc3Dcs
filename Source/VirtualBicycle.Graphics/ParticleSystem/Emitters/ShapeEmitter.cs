...
namespace R3D.GraphicsEngine.ParticleSystem.Emitters
{
    ...
    /// </summary>
    [Serializable]
    public class ShapeEmitter<T> : Emitter<T> where T : IParticle, new()
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        protected override void GenerateParticleOffsetAndOrientation(out Vector2 offset, out Vector2 orientation)
        {
            ...
            offset = new Vector2(MathEx.Lerp(a.X, b.X, rndPos), MathEx.Lerp(a.Y, b.Y, rndPos));

            float rads = (float)Random.NextDouble() * MathEx.TwoPi;
