...
namespace VirtualBicycle.CollisionModel.Shapes
{
    ...
    public class EmptyShape : ConcaveShape
    {
        ...
        public override void ProcessAllTriangles(ITriangleCallback callback, VirtualBicycle.Physics.MathLib.Vector3 aabbMin, VirtualBicycle.Physics.MathLib.Vector3 aabbMax)
        {
