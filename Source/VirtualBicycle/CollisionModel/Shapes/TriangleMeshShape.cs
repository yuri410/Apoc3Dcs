...
namespace VirtualBicycle.CollisionModel.Shapes
{
    ...
    public class TriangleMeshShape : ConcaveShape
    {
        ...
        public StridingMeshInterface MeshInterface
        {
            ...
            protected set { _meshInterface = value; }
        }
        protected Vector3 LocalAabbMin
        {
            get { return _localAabbMin; }
            set { _localAabbMin = value; }
        }
        protected Vector3 LocalAabbMax
        {
            get { return _localAabbMax; }
            set { _localAabbMax = value; }
        }
        ...
        public override void GetAabb(Matrix t, out Vector3 aabbMin, out Vector3 aabbMax)
        {
            ...
            Matrix abs_b = MathUtil.Absolute(t);

            Vector3 center = MathUtil.MatrixToVector(t, localCenter);
