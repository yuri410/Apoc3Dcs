...
namespace VirtualBicycle.CollisionModel.Shapes
{
    ...
    public class MinkowskiSumShape : ConvexShape
    {
        ...
        {
            Vector3 supVertexA = MathUtil.MatrixToVector(_transformA, _shapeA.LocalGetSupportingVertexWithoutMargin(Vector3.TransformNormal(vec, _transformA)));
            Vector3 supVertexB = MathUtil.MatrixToVector(_transformB, _shapeB.LocalGetSupportingVertexWithoutMargin(Vector3.TransformNormal(vec, _transformB)));
