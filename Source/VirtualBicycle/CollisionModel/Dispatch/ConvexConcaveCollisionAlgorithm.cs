...
namespace VirtualBicycle.CollisionModel.Dispatch
{
    ...
    public class ConvexConcaveCollisionAlgorithm : CollisionAlgorithm
    {
        ...
        public override float CalculateTimeOfImpact(CollisionObject bodyA, CollisionObject bodyB, DispatcherInfo dispatchInfo, ManifoldResult resultOut)
        {
            ...
            Matrix triInv = MathUtil.InvertMatrix(triBody.WorldTransform);
            ...
            if (triBody.CollisionShape.IsConcave)
            {
                ...
                MathUtil.SetMin(ref rayAabbMin, convexToLocal.Translation);
                Vector3 rayAabbMax = convexFromLocal.Translation;
                MathUtil.SetMax(ref rayAabbMax, convexToLocal.Translation);
        ...
        private class LocalTriangleSphereCastCallback : ITriangleCallback
        {
            ...
            public Matrix CcdSphereFromTrans
            {
                get { return _ccdSphereFromTrans; }
                set { _ccdSphereFromTrans = value; }
            }
            public Matrix CcdSphereToTrans
            {
                get { return _ccdSphereToTrans; }
                set { _ccdSphereToTrans = value; }
            }
            ...
            {
                get { return _ccdSphereRadius; }
                set { _ccdSphereRadius = value; }
            }
