...
namespace VirtualBicycle.CollisionModel.Dispatch
{
    ...
    public class CollisionObject
    {
        ...
        {
            get { return (_collisionFlags & CollisionOptions.StaticObject) != 0; }
        }
        public bool IsKinematicObject
        {
            get { return (_collisionFlags & CollisionOptions.KinematicObject) != 0; }
        }
        public bool IsStaticOrKinematicObject
        {
            get { return (_collisionFlags & (CollisionOptions.KinematicObject | CollisionOptions.StaticObject)) != 0; }
        }

        public bool HasContactResponse
        {
            get { return (_collisionFlags & CollisionOptions.NoContactResponse) == 0; }
        }
        ...
        {
            get { return ((ActivationState != ActivationState.IslandSleeping) && (ActivationState != ActivationState.DisableSimulation)); }
        }
        ...
        {
            get { return _deactivationTime; }
            set { _deactivationTime = value; }
        }
        public object Owner
        {
            get { return _internalOwner; }
            protected set { _internalOwner = value; }
        }
        ...
        {
            get { return _interpolationWorldTransform; }
            set { _interpolationWorldTransform = value; }
        }
        public Vector3 InterpolationLinearVelocity
        {
            get { return _interpolationLinearVelocity; }
            protected set { _interpolationLinearVelocity = value; }
        }
        public Vector3 InterpolationAngularVelocity
        {
            get { return _interpolationAngularVelocity; }
            protected set { _interpolationAngularVelocity = value; }
        }
        public int IslandTag
        {
            get { return _islandTag; }
            set { _islandTag = value; }
        }
        ...
        {
            get { return _ccdSweptSphereRadius; }
            set { _ccdSweptSphereRadius = value; }
        }
        // Don't do continuous collision detection if square motion (in one step) is less then m_ccdSquareMotionThreshold
        public float CcdSquareMotionThreshold
        {
            get { return _ccdSquareMotionThreshold; }
            set { _ccdSquareMotionThreshold = value; }
        }
        ...
        {
            get { return _companionID; }
            set { _companionID = value; }
        }
        protected bool CheckCollide
        {
            get { return _checkCollideWith; }
            set { _checkCollideWith = value; }
        }
