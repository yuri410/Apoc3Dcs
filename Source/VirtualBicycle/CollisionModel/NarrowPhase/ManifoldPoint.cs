...
namespace VirtualBicycle.CollisionModel.NarrowPhase
{
    ...
    public class ManifoldPoint
    {
        ...
        {
            get { return _positionWorldOnA; }
            set { _positionWorldOnA = value; }
        }
        public Vector3 PositionWorldOnB
        {
            get { return _positionWorldOnB; }
            set { _positionWorldOnB = value; }
        }

        public Vector3 LocalPointA
        {
            get { return _localPointA; }
            set { _localPointA = value; }
        }
        public Vector3 LocalPointB
        {
            get { return _localPointB; }
            set { _localPointB = value; }
        }

        public Vector3 NormalWorldOnB
        {
            get { return _normalWorldOnB; }
        }

        public float CombinedFriction
        {
            get { return _combinedFriction; }
            set { _combinedFriction = value; }
        }
        public float CombinedRestitution
        {
            get { return _combinedRestitution; }
            set { _combinedRestitution = value; }
        }

        public object UserPersistentData
        {
            get { return _userPersistentData; }
            set { _userPersistentData = value; }
        }
    }
}
