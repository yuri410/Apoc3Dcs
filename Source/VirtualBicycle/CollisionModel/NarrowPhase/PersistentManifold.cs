...
namespace VirtualBicycle.CollisionModel.NarrowPhase
{
    [Serializable]
    ...
    public class PersistentManifold
    {
        ...
        {
            get { return _cachedPoints; }
        }

        public static ContactDestroyedCallback ContactDestroyedCallback
        {
            get { return _contactDestroyedCallback; }
            set { _contactDestroyedCallback = value; }
        }
        public static float ContactBreakingThreshold
        {
        ...
        public void RefreshContactPoints(Matrix trA, Matrix trB)
        {
            ...
            for (int i = ContactsCount - 1; i >= 0; i--)
            {
                ...
                manifoldPoint.PositionWorldOnA = MathUtil.MatrixToVector(trA, manifoldPoint.LocalPointA);
                manifoldPoint.PositionWorldOnB = MathUtil.MatrixToVector(trB, manifoldPoint.LocalPointB);
        ...
        private int SortCachedPoints(ManifoldPoint pt)
        {
            ...
            int biggestarea = MathUtil.ClosestAxis(maxvec);
            return biggestarea;
        }
