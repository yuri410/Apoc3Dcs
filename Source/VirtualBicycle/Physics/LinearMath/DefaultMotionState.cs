...
namespace VirtualBicycle.Physics
{
    ...
    public class DefaultMotionState : MotionState
    {
        ...
        public Matrix GraphicsWorldTransform
        {
            get { return _graphicsWorldTransform; }
            set { _graphicsWorldTransform = value; }
        }
        ...
        {
            get { return _startWorldTransform; }
            set { _startWorldTransform = value; }
        }
        ...
        {
            centerOfMassWorldTrans = MathUtil.InvertMatrix(_centerOfMassOffset) * _graphicsWorldTransform;
        }
