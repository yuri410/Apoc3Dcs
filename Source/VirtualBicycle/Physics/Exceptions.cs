...
namespace VirtualBicycle.Physics
{
	...
	{
		internal PhysicsException()
			: base("Bullet Physics Library has thrown an exception.")
		{
		}

		internal PhysicsException(string message)
			: base(message)
		{
		}

		internal PhysicsException(string message, Exception innerException)
			: base(message, innerException)
		{
		}

#if !XBOX
		internal PhysicsException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
#endif
