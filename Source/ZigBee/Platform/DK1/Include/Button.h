...
#define BUTTON_0_PIN                    BUTTON_0_MASK << BUTTON_BASE_BIT
#define BUTTON_1_PIN                    BUTTON_1_MASK << BUTTON_BASE_BIT
#define BUTTON_2_PIN                    BUTTON_2_MASK << BUTTON_BASE_BIT
#define BUTTON_3_PIN                    BUTTON_3_MASK << BUTTON_BASE_BIT

#define u8ButtonReadRfd() \
            ((uint8)(((u32AHI_DioReadInput() >> BUTTON_BASE_BIT) \
                      & BUTTON_ALL_MASK_RFD) ^ BUTTON_ALL_MASK_RFD))
#define u8ButtonReadFfd() \
            ((uint8)(((u32AHI_DioReadInput() >> BUTTON_BASE_BIT) \
                      & BUTTON_ALL_MASK_FFD) ^ BUTTON_ALL_MASK_FFD))
