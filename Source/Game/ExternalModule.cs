...
namespace VirtualBicycle
{
    public abstract class ExternalModule
    {
        ...
        protected ExternalModule(VirtualBicycle.IO.ResourceLocation fl, bool checkPdb)
        {
            ...
            if (checkPdb)
            {
                ...
                if (fileLoc != null)
                {
                    ...
                    pdbFile = FileSystem.Instance.TryLocate(pdbPath, FileLocateRules.Default);
                    //if (pdbFile != null)                                                   
                }
            }
            ...
            if (pdbFile != null)
            {
                ContentBinaryReader pdbBr = new ContentBinaryReader(pdbFile);
        ...
        protected ExternalModule(VirtualBicycle.IO.ResourceLocation fl, bool allowEnc, bool checkPdb)
        {
            IO.FileLocation pdbFile = null;
            ...
            {
                EngineConsole.Instance.Write("ResourceAssembly.Instance.CM_AssemblyEncrypted(fl.ToString())");
