...
namespace VirtualBicycle.CollisionModel.NarrowPhase
{
    ...
    public class GjkEpa
    {
        ...
        private static readonly float _infinity = MathUtil.Infinity;
        ...
        public static float EpaAccuracy
        {
            get { return _epaAccuracy; }
        }
        ...
        public class Gjk
        {
            ...
            public MinkowskiVertice[] Simplex
            {
                get { return _simplex; }
            }
            ...
            public Vector3 LocalSupport(Vector3 d, int i)
            {
                ...
                Vector3 result = MathUtil.MatrixToVector(_wrotations[i], _shapes[i].LocalGetSupportingVertex(vtx));
