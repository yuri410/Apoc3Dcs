...
#pragma warning disable 
    ...
    public class GjkPairDetector : DiscreteCollisionDetectorInterface
    {
        ...
        public static int DeepPenetrationChecksCount
        {
            get { return _numDeepPenetrationChecks; }
        }
        public static int GjkChecksCount
        {
            get { return _numGjkChecks; }
        }
        #endregion
        ...
        public override void GetClosestPoints(DiscreteCollisionDetectorInterface.ClosestPointInput input, DiscreteCollisionDetectorInterface.Result output, IDebugDraw debugDraw)
        {
            ...
            {
                float squaredDistance = MathUtil.Infinity;
                float delta = 0;
                ...
                while (true)
                {
                    ...
                    Vector3 pWorld = MathUtil.MatrixToVector(localTransA, pInA);
                    Vector3 qWorld = MathUtil.MatrixToVector(localTransB, qInB);
                    ...
                    if (previouseSquaredDistance - squaredDistance <= MathUtil.Epsilon * previouseSquaredDistance)
                    {
...
#warning Check this
                    if (_penetrationDepthSolver != null)
                    {
                        ...
                        if (isValid2)
                        {
                            ...
                            if (lengSqr > (MathUtil.Epsilon * MathUtil.Epsilon))
                            {
