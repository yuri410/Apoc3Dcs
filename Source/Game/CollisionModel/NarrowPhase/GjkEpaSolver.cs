...
namespace VirtualBicycle.CollisionModel.NarrowPhase
{
    ...
    public class GjkEpaSolver
    {
        ...
        public struct Results
        {
            ...
            {
                get { return _epaIterations; }
                set { _epaIterations = value; }
            }
            public int GjkIterations
            {
                get { return _gjkIterations; }
                set { _gjkIterations = value; }
            }
                    ...
                    out Results results)
        {
            ...
            if (collide)
            {
                ...
                {
                    if (epa.Failed) results.ResultStatus = Results.Status.EpaFailed;
                }
            }
            else
            {
                if (gjk.Failed) results.ResultStatus = Results.Status.GjkFailed;
            }
            return false;
        }
    }
