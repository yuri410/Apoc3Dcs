...
namespace VirtualBicycle.CollisionModel.Shapes
{
    ...
    class AabbCalculationCallback : ITriangleIndexCallback
    {
        ...
        {
            MathUtil.SetMin(ref _aabbMin, triangle[0]);
            MathUtil.SetMax(ref _aabbMax, triangle[0]);
            MathUtil.SetMin(ref _aabbMin, triangle[1]);
            MathUtil.SetMax(ref _aabbMax, triangle[1]);
            MathUtil.SetMin(ref _aabbMin, triangle[2]);
            MathUtil.SetMax(ref _aabbMax, triangle[2]);
        }
        #endregion
    }
