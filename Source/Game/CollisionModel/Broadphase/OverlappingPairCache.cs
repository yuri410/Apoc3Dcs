...
namespace VirtualBicycle.CollisionModel.Broadphase
{
    ...
    public abstract class OverlappingPairCache : IBroadphase
    {
        ...
        public List<BroadphasePair> OverlappingPairs
        {
            get { return _overlappingPairs; }
            set { _overlappingPairs = value; }
        }
        public bool BlockedForChanges
        {
            get { return _blockedForChanges; }
            set { _blockedForChanges = value; }
        }
        public IOverlapFilterCallback OverlapFilterCallback
        {
            get { return _overlapFilterCallback; }
            set { _overlapFilterCallback = value; }
        }

        public static int OverlappingPairCount
        {
            get { return _overlappingPairCount; }
            set { _overlappingPairCount = value; }
        }
        ...
        public void AddOverlappingPair(BroadphaseProxy proxyA, BroadphaseProxy proxyB)
        {
            ...
            PhysDebug.Assert(proxyA != proxyB);
        ...
        public abstract BroadphaseProxy CreateProxy(VirtualBicycle.Physics.MathLib.Vector3 min, VirtualBicycle.Physics.MathLib.Vector3 max, BroadphaseNativeTypes shapeType, object userData, BroadphaseProxy.CollisionFilterGroups collisionFilterGroup, BroadphaseProxy.CollisionFilterGroups collisionFilterMask);

        public abstract void DestroyProxy(BroadphaseProxy proxy);

        public abstract void SetAabb(BroadphaseProxy proxy, VirtualBicycle.Physics.MathLib.Vector3 aabbMin, VirtualBicycle.Physics.MathLib.Vector3 aabbMax);
