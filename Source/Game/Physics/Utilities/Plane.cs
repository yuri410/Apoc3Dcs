...
namespace VirtualBicycle.Physics.MathLib
{
    ...
    public struct Plane : IEquatable<Plane>
    {
        ...
        public static implicit operator SlimDX.Plane(Plane v)
        {
            return new SlimDX.Plane(v.Normal.X, v.Normal.Y, v.Normal.Z, v.D);
        }
        public static implicit operator Plane(SlimDX.Plane v)
        {
            return new Plane(v.Normal.X, v.Normal.Y, v.Normal.Z, v.D);
        }
    }
}
