...
namespace VirtualBicycle.Physics.Dynamics
{
    ...
    public class RigidBody : CollisionObject
    {
        ...
        Vector3 myTotalForce;
        public Vector3 TotalForce
        {
            get { return myTotalForce; }
        }

        Vector3 myTotalTorque;
        ...
        {
            get { return myTotalTorque; }
        }

        public int DebugBodyID
        {
            get { return _debugBodyId; }
            set { _debugBodyId = value; }
        }

        public ContactSolverType ContactSolverType
        {
            get { return _contactSolverType; }
            set { _contactSolverType = value; }
        }
        public ContactSolverType FrictionSolverType
        {
            get { return _frictionSolverType; }
            set { _frictionSolverType = value; }
        }
        ...
        {
            get { return _invInertiaTensorWorld; }
        }
        ...
        {
            get { return _invInertiaLocal; }
            set { _invInertiaLocal = value; }
        }
        ...
        {
            get { return Quaternion.CreateFromRotationMatrix(WorldTransform); }
            set
            {
                Vector3 tr = WorldTransform.Translation;
        ...
        public Vector3 LinearVelocity
        {
            ...
            set
            {
                if (CollisionFlags == CollisionOptions.StaticObject)
                    throw new PhysicsException("Static objects can't have linear velocity!");
        ...
        public Vector3 AngularVelocity
        {
            ...
            {
                if (CollisionFlags == CollisionOptions.StaticObject)
                    throw new PhysicsException("Static objects can't have angular velocity!");
        ...
        public int ConstrainRefCount
        {
            get { return _constraintRefs.Count; }
        }

        public static float LinearAirDamping
        {
            get { return _linearAirDamping; }
            set { _linearAirDamping = value; }
        }
        public static float RigidBodyDeactivationTime
        {
            get { return _rigidBodyDeactivationTime; }
            set { _rigidBodyDeactivationTime = value; }
        }
        public static bool DisableDeactivation
        {
            get { return _disableDeactivation; }
            set { _disableDeactivation = value; }
        }
        public static float LinearSleepingThreshold
        {
            get { return linearSleepingThreshold; }
            set { linearSleepingThreshold = value; }
        }
        public static float AngularSleepingThreshold
        {
            get { return angularSleepingThreshold; }
        ...
        public void IntegrateVelocities(float step)
        {
            ...
            float MAX_ANGVEL = VirtualBicycle.Physics.MathLib.MathHelper.PiOver2;
            ...
            myTotalForce = _totalForce;
            myTotalTorque = _totalTorque;
            ClearForces();
        }
