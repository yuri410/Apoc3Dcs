...
namespace VirtualBicycle.Physics.Dynamics
{
    ...
    public class SolverConstraint
    {
        ...
        public Vector3 RelPosACrossNormal
        {
            get { return _relpos1CrossNormal; }
            set { _relpos1CrossNormal = value; }
        }
        public Vector3 RelPosBCrossNormal
        {
            get { return _relpos2CrossNormal; }
            set { _relpos2CrossNormal = value; }
        }
        ...
        {
            get { return _appliedVelocityImpulse; }
            set { _appliedVelocityImpulse = value; }
        }
        public int SolverBodyIdA
        {
            get { return _solverBodyIdA; }
            set { _solverBodyIdA = value; }
        }
        public int SolverBodyIdB
        {
            get { return _solverBodyIdB; }
            set { _solverBodyIdB = value; }
        }
        ...
        {
            get { return _frictionIndex; }
            set { _frictionIndex = value; }
        }
        public int[] UnusedPadding
        {
            get { return _unusedPadding; }
            set { _unusedPadding = value; }
        }
