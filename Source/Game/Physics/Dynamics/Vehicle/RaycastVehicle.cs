...
namespace VirtualBicycle.Physics.Dynamics
{
    ...
    public class RaycastVehicle : TypedConstraint
    {
        ...
        public struct VehicleTuning
        {
            ...
            {
                get { return _suspensionCompression; }
                set { _suspensionCompression = value; }
            }
            public float SuspensionDamping
            {
                get { return _suspensionDamping; }
                set { _suspensionDamping = value; }
            }
...
#pragma warning disable 
        ...
        float _currentVehicleSpeedKmHour;
        ...
        public float RayCast(WheelInfo wheel)
        {
            ...
            Trace.Assert(this._vehicleRaycaster != null);
            ...
            object obj = _vehicleRaycaster.CastRay(source, target, out rayResults);
        ...
        public void UpdateVehicle(float step)
        {
            ...
            _currentVehicleSpeedKmHour = 3.6f * this.RigidBody.LinearVelocity.Length();
            ...
            Vector3 forwardW = new Vector3(
                chassisTransa[0][_indexForwardAxis],
                chassisTransa[1][_indexForwardAxis],
                chassisTransa[2][_indexForwardAxis]);

            if (Vector3.Dot(forwardW, this.RigidBody.LinearVelocity) < 0.0f)
            {
                _currentVehicleSpeedKmHour *= -1.0f;
            }
            ...
            for (int i = 0; i < _wheelInfo.Count; i++)
            {
                ...
                if (wheel.RaycastInfo.IsInContact)
                {
                    ...
                    Vector3 fwd = new Vector3(
                        chassisWorldTransformA[0][_indexForwardAxis],
                        chassisWorldTransformA[1][_indexForwardAxis],
                        chassisWorldTransformA[2][_indexForwardAxis]);
        ...
        public void UpdateSuspension(float deltaTime)
        {
            ...
            float chassisMass = 1.0f / _chassisBody.InverseMass;
...
#warning "highly unoptimised"
        ...
        public void UpdateFriction(float timeStep)
        {
            ...
            for (int i = 0; i < GetNumWheels(); i++)
            {
                ...
                if (groundObject != null)
                {
                    ...
                    axle[i] = new Vector3(
                        wheelBasis0a[0][_indexRightAxis],
                        wheelBasis0a[1][_indexRightAxis],
                        wheelBasis0a[2][_indexRightAxis]);
                ...
                for (int wheel = 0; wheel < GetNumWheels(); wheel++)
                {
                    ...
                    if (groundObject != null)
                    {
                        ...
                        else
                        {
                            ...
                            WheelContactPoint contactPt = new WheelContactPoint(_chassisBody, groundObject, wheelInfo.RaycastInfo.ContactPointWS, forwardWS[wheel], maxImpulse);
            ...
            // apply the impulses
            {
                for (int wheel = 0; wheel < GetNumWheels(); wheel++)
                {
                    ...
                    {
                        _chassisBody.ApplyImpulse(forwardWS[wheel] * (forwardImpulse[wheel]), rel_pos);
                    }
                    if (sideImpulse[wheel] != 0.0f)
                    {
        ...
        public float CurrentSpeedKmHour { get { return _currentVehicleSpeedKmHour; } }
