    ...
    public abstract class ScriptableObject : IDisposable
    {
        ...
        protected ScriptableObject(string typeName)
        {
            ...
            if (typeName != null)
                ...
                EngineConsole.Instance.Write("ResourceAssembly.Instance.CM_ScriptNotUsed(this)", ConsoleMessageType.Exclamation);
        }
        ...
        protected void PostLoad(string typeName)
        {
            ...
            //if (g != null)
            //{
            ScriptAssembly em = ServiceHelper.CurrentAssembly;
            // 如果有脚本程序集
            if (em != null)
            {
        ...
        void ScriptLoaded()
        {
            EngineConsole.Instance.Write("ResourceAssembly.Instance.CM_ScriptLoaded(this)", ConsoleMessageType.Information);
        }
                    ...
                    if (methods.TryGetValue(mName, out sp) && sp.AutoBind)
                    {
                        ...
                        if (scrParam.Length != eventParam.Length)
                            throw new InvalidScriptException(
                                ...
                                sp.Sign + ". Should be:" + mName + ScriptProc.GetSign(eventParam));
