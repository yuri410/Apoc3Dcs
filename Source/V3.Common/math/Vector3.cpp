...
namespace V3
{
	...
	Vector3 Vector3::Project( Vector3 vector, V3::Viewport viewport, Matrix projection, Matrix view, Matrix world )
	{
		Vector3 result;
	...
	void Vector3::Project( Vector3% vector, V3::Viewport% viewport, Matrix% projection, Matrix% view, Matrix% world, [Out] Vector3% result )
	{
		pin_ptr<Vector3> pinVector = &vector;
		pin_ptr<V3::Viewport> pinViewport = &viewport;
	...
	Vector3 Vector3::Unproject( Vector3 vector, V3::Viewport viewport, Matrix projection, Matrix view, Matrix world )
	{
		Vector3 result;
	...
	void Vector3::Unproject( Vector3% vector, V3::Viewport% viewport, Matrix% projection, Matrix% view, Matrix% world, [Out] Vector3% result )
	{
		pin_ptr<Vector3> pinVector = &vector;
		pin_ptr<V3::Viewport> pinViewport = &viewport;
		pin_ptr<Matrix> pinProjection = &projection;
