...
namespace V3
{
	...
	[System::ComponentModel::TypeConverter( V3::Design::Vector3Converter::typeid )]
	...
	public:
		...
		static Vector3 Project( Vector3 vector, V3::Viewport viewport, Matrix projection, Matrix view, Matrix world );
		...
		static void Project( Vector3% vector, V3::Viewport% viewport, Matrix% projection, Matrix% view, Matrix% world, [Out] Vector3% result );
		...
		static Vector3 Unproject( Vector3 vector, V3::Viewport viewport, Matrix projection, Matrix view, Matrix world );
		...
		static void Unproject( Vector3% vector, V3::Viewport% viewport, Matrix% projection, Matrix% view, Matrix% world, [Out] Vector3% result );
